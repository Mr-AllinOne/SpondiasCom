...
const ProLead = () => {
    return (
        <>
            <div className="mx-10  mt-10 flex flex-row flex-1  items-center px-5 py-4 pr-2 gap-4">
                <div className="flex flex-col px-2 w-[60%] gap-2">
                    <div className='flex mx-5 space-x-2  font-semibold'>
                        <span className='text-4xl tracking-wide'>PROPERTY</span>
                        <spn className='text-4xl font-semibold text-[#4fa1f4] px-2'>LEADS</spn>
                    </div>
                ...
                <div className="h-[255px] w-[350px] rounded-lg flex justify-center items-center" >
                    <img src="./images/crm/propertyLead.png" alt="bankSpan" className="h-[250px] w-[250px]" />
                </div>
            </div>
            <div className="mx-20 mt-10 py-2  mb-4 px-20">
                <img src='./images/crm/crmImage.png' alt='fintech' width='1000px' className='bg-contain' />
            </div>
        </>
    )
}
