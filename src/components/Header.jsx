...
const Header = () => {
    ...
    return (
        ...
        <header className='flex justify-between  items-center  h-24 max-w-[1240px] mx-auto px-10 '>
            ...
            <div className >
                <img
                    src='./public/logos/logo_page.png'
                    alt='logo'
                    className='h-18 w-25'
                />
            </div>
            ...
            <div className={!navshow ? 'md:hidden  fixed w-[50%]  left-0 top-0  border-r-gray-900 h-full bg-gray-100 eas-in-out duration-500' : 'md:hidden fixed left-[-100%]'}>
                <div>
                    <img
                        src='./logos/logo_page.png'
                        alt='logo'
                        className=' m-4 h-18 w-[100px]'
                    />
                </div>
